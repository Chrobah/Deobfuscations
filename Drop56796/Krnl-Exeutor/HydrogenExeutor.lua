--[[
    HydrogenExeutor.lua  —  organised by minimarchbleeding
    Original : Drop56796/Krnl-Exeutor  ->  HydrogenExeutor.lua
    Clean loader (not obfuscated); pulls: https://raw.githubusercontent.com/Drop56796/Mercury/main/Mercury.lua
--]]
