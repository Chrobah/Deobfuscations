--[[
    Hydraulic Doors.lua  —  organised by minimarchbleeding
    Original : Drop56796/CreepyEyeHub  ->  Hydraulic Doors.lua
...
local RightGroup2 = Tabs.Main:AddRightGroupbox('Event :')
