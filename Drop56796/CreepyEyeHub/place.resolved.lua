-- source: github.com/Drop56796/CreepyEyeHub  (place.lua)
-- [resolved Unknown-VM] https://github.com/Drop56796/CreepyEyeHub/blob/main/Fliesob.lua?raw=true — deobfuscating target:

-- (remote Unknown-VM target — recovered constant pool)
--   [URLs] https://raw.githubusercontent.com/Drop56796/CreepyEyeHub/main/Configs.lua

-- ========================================

-- source: github.com/Drop56796/CreepyEyeHub  (place.lua)
-- [resolved CLEAN] https://github.com/Drop56796/new/blob/main/Script.lua?raw=true  (80665 bytes)
...
-- (nested) https://raw.githubusercontent.com/DarkSuffer/BasicallyAnDoors-EDITED/main/uilibs/Mobile.lua
