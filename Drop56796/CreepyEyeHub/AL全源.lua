--[[
    AL全源.lua  —  organised by minimarchbleeding
    Original : Drop56796/CreepyEyeHub  ->  AL全源.lua
    Clean loader (not obfuscated); pulls: https://pastebin.com/raw/3vQbADjh, https://pastebin.com/raw/GnvPVBEi, https://raw.githubusercontent.com/XiaoYunCN/UWU/main/%E5%B7%A5%E4%BD%9C%E5%AE%A4.LUA, https://cdn.wearedevs.net/scripts/BTools.txt
--]]

local library = loadstring(game:HttpGet("https://pastebin.com/raw/3vQbADjh", true))()
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("臭缝合合集by Advanced Logic")--V2.1.3
----------------------------------------------------------------------------------------------------------------------------------------
