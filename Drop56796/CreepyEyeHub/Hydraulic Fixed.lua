--[[
    Hydraulic Fixed.lua  —  organised by minimarchbleeding
    Original : Drop56796/CreepyEyeHub  ->  Hydraulic Fixed.lua
    Clean loader (not obfuscated); pulls: https://github.com/Drop56796/CreepyEyeHub/blob/main/UI%20Style%20theme.lua?raw=true, https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors/Custom%20Achievements/Source.lua
--]]
...
local s = Tabs.s:AddLeftGroupbox('Item')
