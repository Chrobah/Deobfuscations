-- source: github.com/Drop56796/CreepyEyeHub  (DOORS PC.lua)
-- [resolved CLEAN] https://raw.githubusercontent.com/KINGHUB01/KING-HUB-NO-1/main/Ui  (256492 bytes)

if game.CoreGui:FindFirstChild("Kings Ui") then
    game.CoreGui:FindFirstChild("Kings Ui"):Destroy()
end
