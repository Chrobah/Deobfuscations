--[[
    Configs.lua  —  organised by minimarchbleeding
    Original : Drop56796/CreepyEyeHub  ->  Configs.lua
    Clean loader (not obfuscated); pulls: https://raw.githubusercontent.com/Drop56796/CreepyEyeHub/main/Script.lua
--]]
