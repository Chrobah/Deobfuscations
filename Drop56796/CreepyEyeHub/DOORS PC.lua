--[[
    DOORS PC.lua  —  organised by minimarchbleeding
    Original : Drop56796/CreepyEyeHub  ->  DOORS PC.lua
    Clean loader (not obfuscated); pulls: https://raw.githubusercontent.com/KINGHUB01/KING-HUB-NO-1/main/Ui, https://raw.githubusercontent.com/BocusLuke/UI/main/STX/Module.Lua, https://raw.githubusercontent.com/BocusLuke/UI/main/STX/Client.Lua, https://raw.githubusercontent.com/zntly/highlight-esp/main/esp.lua
--]]

local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/KINGHUB01/KING-HUB-NO-1/main/Ui", true))()
local entitynames = {"RushMoving","AmbushMoving","Snare","A60","A120","A90"}

local PepsiUi = library:CreateWindow({
    Name = "Creepy Client HUB / ["..game.Players.LocalPlayer.Name.."] ",
    Theme = {
...
TestTab:AddToggle({
    ...
    if val then
        ...
        addconnect = workspace.ChildAdded:Connect(function(v)
            ...
            Notification:Notify(
    {Title = "KING HUB Notification", Description = v.Name:gsub("Moving",""):lower().." Spawned Hide!"},
