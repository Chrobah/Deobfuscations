--[[ DoorsFixed.lua  —  upstream payload fetched by minimarchbleeding ]]
-- [resolved CLEAN] https://github.com/Drop56796/UI-POOP/blob/main/NU%C3%91EZSCRIPTS.lua?raw=true  (123807 bytes)
