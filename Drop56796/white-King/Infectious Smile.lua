--[[
    Infectious Smile.lua  —  organised by minimarchbleeding
    Original : Drop56796/white-King  ->  Infectious Smile.lua
    Clean loader (not obfuscated); pulls: https://github.com/Drop56796/CreepyEyeHub/blob/main/Splix.lua?raw=true
--]]
