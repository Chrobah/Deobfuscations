--[[
    Example.lua  —  organised by minimarchbleeding
    Original : Drop56796/Andazx  ->  Example.lua
    Clean loader (not obfuscated); pulls: https://raw.githubusercontent.com/Drop56796/Andazx/main/UI%20Lib.lua
--]]
